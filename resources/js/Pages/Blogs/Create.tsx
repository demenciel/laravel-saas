...
export default function Create({ auth }: PageProps) {
        ...
        post(route('blog.store'), {
            ...
            onError: (errors) => {
                if (errors) {
                    ...
                    showSnackbar('Failed to create blog. Please correct the errors and try again.', 'error');
                } else {
    ...
    return (
        ...
        >
            <Head>
                <title>Create a Blog Post | TechnoSaas</title>
                <meta name="description" content="Easily create a new blog post with the TechnoSaas Dashboard. Share your expertise and engage your audience through high-quality content creation." />
                <meta name="keywords" content="Create Blog Post, SaaS Blog, Write Blog, Tech Blog, SaaS Dashboard, Blog Article, Blog Management, Blogging Platform, TechnoSaas" />
                <meta property="og:title" content="Create a New Blog Post | TechnoSaas" />
                <meta property="og:description" content="Use the TechnoSaas Dashboard to easily write and publish a new blog post. Engage your audience with fresh, high-quality content." />
                <meta property="og:url" content={`${appUrl}/blog/create`} />
                <meta property="og:image" content={`${appUrl}/Preview.png`} />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Create a New Blog Post | TechnoSaas" />
                <meta name="twitter:description" content="Start creating your blog post with TechnoSaas. A simple and powerful tool for bloggers to share their knowledge." />
